...
export const oauthProviders = ["combini"] as const;

// Note: the combini provider offers log in with Google via combini. However it only supports auth. If more scope
