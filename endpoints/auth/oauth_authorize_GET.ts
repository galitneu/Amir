...
export async function handle(request: Request) {
  try {
    ...
    try {
      ...
      await db
        ...
        .values({
          ...
          redirect_url: oauthProvider.redirectUri,
          code_verifier: codeVerifier || "", // Provide empty string if no code_verifier
    ...
    // The response should be non-empty beacuse Combini backend runs on streaming lambda and will hang otherwise.
